...
router.patch('/updatePassword', authController.verifyPassword, authController.updatePassword);
router.patch('/updateEmail', authController.verifyPassword, authController.updateEmail);
